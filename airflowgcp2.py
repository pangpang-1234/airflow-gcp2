...
with DAG(
    ...
    schedule_interval='@once'
        ...
        partition_dataset = BigQueryCreateEmptyDatasetOperator(task_id='partition_dataset', dataset_id=PARTITION_DATASET)
        
        # Create partition tables
        partition_table = PythonOperator(
            task_id='partition',
            python_callable=create_partition_table,
            op_kwargs={'BIGQUERY_CLIENT':BIGQUERY_CLIENT, 'PARTITION_DATASET':PARTITION_DATASET, 'DATASET_NAME':DATASET_NAME}
        ) 
